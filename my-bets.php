...
if (isset($_SESSION['user'])) {
    $id = $user_id;
    $sql_bets = "SELECT l.image as image, l.name as name, u.contact as contact, c.name as category, l.date_end as date_end, l.start_price as price, b.bet_date as date_create, b.bet_price as bet_price, b.lot_id as lot_id FROM bet b
